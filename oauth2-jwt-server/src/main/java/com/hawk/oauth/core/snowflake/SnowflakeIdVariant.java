package com.hawk.oauth.core.snowflake;
...
public class SnowflakeIdVariant {
     ...
     * 构造函数
     */
    public SnowflakeIdVariant(SnowflakeProp snowflakeProp) {
     ...
     * @return SnowflakeId
     */
    public synchronized String nextId(String bizCode) {
    ...
    public static void main(String[] args) throws InterruptedException {
        SnowflakeProp snowflakeProp = new SnowflakeProp();
        SnowflakeIdVariant idWorker = new SnowflakeIdVariant(snowflakeProp);
        long time1 = System.currentTimeMillis();
        for (int i = 0; i < 1000; i++) {
            String id = idWorker.nextId("ORC");
            //Thread.sleep(1);
